...
Writing `/goal` in ordinary prose does not prove that a persistent Host Goal exists. Use the current Codex
surface to create, inspect, block, resume, and complete it.
:::
